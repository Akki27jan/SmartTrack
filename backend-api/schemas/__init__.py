from schemas.company import Company, CompanySignup, CompanyLogin
from schemas.employee import Employee, EmployeeSignup, EmployeeLogin
from schemas.hr import CompanyHR, HRSignup, HRLogin
